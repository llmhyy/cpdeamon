...
import org.eposoft.jccd.preprocessors.java.CollapseArrayElementAccess;
...
import org.eposoft.jccd.preprocessors.java.GeneralizeNewOperatorTypes;
...
import org.eposoft.jccd.preprocessors.java.ReduceIdentifiersToLastSubstring;
...
import org.eposoft.jccd.preprocessors.java.RemoveEmptyGroupNodes;
...
import org.eposoft.jccd.preprocessors.java.RemoveVariableDeclarationNodes;
...
public class JCCDEvaluation {
     ...
     * Main method.
     *
     * @param args parameters, not needed yet
     */
    public static void main(String[] args) {
        String[] javaFilesPath=JavaFiles.getJavaFilesPathArray("D:\\database\\maven-master",false);
//        File file=new File("")
        args=new String[javaFilesPath.length+1];
        for (int i = 0; i < javaFilesPath.length; i++) {
            String path = javaFilesPath[i];
            args[i+1]=path;
        }
        args[0]="--write=D:\\clonepair\\clone.txt";
...
//        }
        ...
        if (useConsistentRenaming) {
            ...
            comp.add(new NumberLiteralToDouble());
;
    ...
    /**
     * @param node any node of the AST
